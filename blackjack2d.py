# -*- coding: utf-8 -*-
"""
Created on Fri Nov 10 08:45:48 2023

@author: ethan.drover
"""
import blackjack_file_func
import cards
...
#         writer = money.txt(file)
#         writer.writerows(money) 

# def read_file(money):
#     money = []
#     with open('money.txt','r', newline='') as file_handler:
#         reader = money.reader(file_handler)
#         for row in reader:
#             #print(f'{row[0]} :-) {row[1]}')
#             money.append([row[0]])
#     return file_handler
...
def main():
    ...
    money = blackjack_file_func.read_money()
    print(f"Money: {money}")
    ...
    while True:
        ...
        blackjack_file_func.write_money(money)
        if money <= 0:
